...
export async function getFromFile(...array) {
    ...
    // fetch(baseURL + "test.js").then(res => {
    ...
    await array.asyncForEach(async function([paths, param]) {
        ...
        await paths.asyncForEach(async function(path) {
            ...
            if ((await fetch(baseURL + "vendor/build-in/after/php/verifyFileExists.php", { method: "POST", body: path })
                    .then((response) => {
                        if (response.ok) {
                ...
                promise.push(
                    fetch(new URL(path, baseURL), { method: param.method, body: param.data })
                    .then((response) => {
                        if (response.ok) {
                            return response.text();
                        } else {
                ...
                if (param.showError) {
                    console.error("function.js:137 POST " + new URL(path, baseURL) + " 404 (Not Found)")
...
export async function getArrayFunction() {
    return await
    import ("./tool/    .js.js.js").default
}
export async function getObjectFunction() {
    return await
    import ("./tool/ObjectFunction.js.js.js").default
}
